...
export default function AgencyCard({ agency }: AgencyCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="bg-[#7C1034] px-4 py-3">
        ...
        <p className="text-white/80 text-xs mt-1">{agency.tipo_de_servicio}</p>
      </div>
      ...
      <div className="p-4 space-y-3">
        ...
        {(phone1 || phone2) && (
          <div className="flex items-start gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              {phone1 && (
                <a href={`tel:${phone1}`} className="text-sm text-[#7C1034] hover:underline">
                  {phone1}{agency.extension_1 && agency.extension_1 !== 'S/N' ? ` ext. ${agency.extension_1}` : ''}
                </a>
              )}
              {phone2 && (
                <a href={`tel:${phone2}`} className="text-sm text-[#7C1034] hover:underline">
        ...
        {agency.correo_electronico && agency.correo_electronico !== 'S/C' && (
          <div className="flex items-start gap-3">
            ...
            <a href={`mailto:${agency.correo_electronico}`} className="text-sm text-[#7C1034] hover:underline">
